...
export const M4create = () => {
    const out = F32(16 as any);
    return M4identity(out);
};

export const M4clone = (a: Matrix) => {
    const out = M4create();
    out[0] = a[0];
    out[1] = a[1];
    out[2] = a[2];
...
export const M4copy = (out: Matrix, a: Matrix) => {
    out[0] = a[0];
    out[1] = a[1];
    out[2] = a[2];
    out[3] = a[3];
...
export const M4identity = (out: Matrix) => {
    out[0] = 1;
    out[1] = 0;
    out[2] = 0;
    out[3] = 0;
...
export const M4multiply = (out: Matrix, a: Matrix, b: Matrix) => {
    const a00 = a[0],
        a01 = a[1],
        a02 = a[2],
        a03 = a[3];
...
export const M4transpose = (out: Matrix, a: Matrix) => {
...
export const M4inverse = (out: Matrix, a: Matrix) => {
    const a00 = a[0],
        a01 = a[1],
        a02 = a[2],
        a03 = a[3];
...
export const M4translate = (out: Matrix, a: Matrix, v: Vector) => {
    const x = v[0],
        y = v[1],
        z = v[2];
    let a00, a01, a02, a03;
...
export const M4scale = (out: Matrix, a: Matrix, v: Vector) => {
    const x = v[0],
        y = v[1],
        z = v[2];
...
export const M4lookAt = (out: Matrix, eye: Vector, center: Vector, up: Vector) => {
